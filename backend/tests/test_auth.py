...
def test_login_exitoso():
    ...
    Verifica que el frontend recibe el token del backend (no de Supabase directo).
...
def test_login_email_invalido():
    """
    TC-020: POST /auth/login con email malformado retorna 422 (validación Pydantic).
